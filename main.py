...
batch_size = 32
IMG_INPUT_DIMS = (64,64)
# Training
n_epochs = 30

# Define the transformation
transform = transforms.Compose([
    transforms.Resize(IMG_INPUT_DIMS),
    transforms.Grayscale(num_output_channels=1),
    transforms.ToTensor()])

# Paths to training and testing data
train_dir = 'datasets/cat_and_dog_dataset/training_set/training_set'
test_dir = 'datasets/cat_and_dog_dataset/test_set/test_set'
...
losses, model_path = train(capsule_net, decoder_loss, optimizer, train_loader, n_epochs=n_epochs)
print(losses)
